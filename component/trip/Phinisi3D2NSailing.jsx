                ...
                <div className={`panel ${checkActive(1, 'active')}`}>
                    <div className="text-justify flex flex-col gap-5">
                        ...
                        {/* <div className="flex gap-2 ml-[5px]">
                            <p>1.</p>
                            <p>
                                Menjelajahi keindahan Labuan Bajo dengan mengunjungi 10 pulau eksotis di sepanjang
                                perjalanan.
                            </p>
                        </div>
                        <div className="flex gap-2">
                            <p>2.</p>
                            <p>Snorkeling sambil menjelajahi ekosistem laut yang masih virgin seperti Manta Ray.</p>
                        </div>
                        <div className="flex gap-2">
                            <p>3.</p>
                            <p>
                                Trekking mengelilingi bukit-bukit yang asri sambil ditemani hewan endemik warisan dunia,
                                Komodo.
                            </p>
                        </div>
                        <div className="flex gap-2">
                            <p>4.</p>
                            <p>
                                Menikmati Sunrise dan Sunset sambil menikmati hidangan lokal yang didampingi keindahan
                                pantai.
                            </p>
                        </div>
                        <div className="flex gap-2">
                            <p>5.</p>
                            <p>Menikmati indahnya panorama eksklusif sepanjang perjalanan.</p>
                        </div>
                        <p>
                            Labuan Bajo sudah terkenal sebagai Surga Wisata yang tersembunyi di Indonesia. Deretan Pulau
                            dengan panorama yang eksotik berhasil memikat wisatawan lokal maupun mancanegara. Keramahan
                            penduduk lokal dan makanan tradisional menambah kenyamanan saat berwisata ke Labuan Bajo.
                        </p>
                        <p>
                            Open Trip Journey Labuan Bajo memberikan pengalaman liburan unik ke 10 destinasi wisata Labuan
                            Bajo. Trip ini berkonsep Living on Board memberikan pengalaman baru berlibur selama 3 Hari 2
                            Malam di atas lautan biru sepanjang Labuan Bajo. Bersifat Open Trip atau rombongan memungkinkan
                            kamu untuk berinteraksi dengan orang-orang baru selama perjalan.
                        </p> */}
                        <p>
                            Sailing Komodo 3 hari 2 malam kapal reguler merupakan rangkaian kegiatan mengelilingi Kepulauan
                        ...
                        <Accordion
                            ...
                            <AccordionItem
                                header="Objek Wisata Apa yang Paling Populer di Labuan Bajo?"
                                initialEntered>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        {/* <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Bertemu di meeting point jam 9 pagi dan perjalanan dimulai menuju Pulau Kelor. Trekking
                                    ke puncak bukit dan menikmati view dari puncak bukit.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                ...
                                />
                                <p>
                                    Dari Pulau Kelor dilanjutkan menuju Manjarite untuk snorkeling bersama ikan-ikan dan
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Dari Manjarite perjalanan dilanjutkan menuju Pulau Kalong untuk menikmati sunset dengan
                                    view jutaan kelelawar yang terbang menutupi langit.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                    ...
                                    className="-mt-0.5 min-w-[20px]"
                                />
                                <p>Istirahat dan menikmati makan malam.</p>
                            </div>

                            <b className="text-[15px]">Day 2</b>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                    size={20}
                                    className="-mt-0.5 min-w-[20px]"
                                />
                                <p>Trekking ke puncak Pulau Kalong melihat pemandangan khas perbukitan ala Jurasik Park.</p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                    size={20}
                                    className="-mt-0.5 min-w-[20px]"
                                />
                                <p>Perjalanan dilanjutkan menuju ke Pulau Padar (trekking dan photo hunting)</p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                    size={20}
                                ...
                                />
                                <p>
                                    Setelah Pulau Padar perjalanan dilanjutkan menuju ke Pulau Komodo untuk bertemu dengan
                                    Komodo, trekking sesuai dengan pilihan rute.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                ...
                                />
                                <p>
                                    Dilanjutkan dengan menuju Pink Beach untuk foto-foto dan bersnorkeling ria di Pink Beach.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                ...
                                />
                                <p>
                                    Singgah di Manta Point untuk bertemu dengan pari manta yang besar, jangan lupa bawa
                                    keberuntungan anda karena mereka tidak pasti ada.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Setelah sarapan langsung menuju Taka Makassar, foto-foto di pulau pasir kecil di tengah
                                    laut.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Perjalanan dilanjutkan menuju Pulau Kanawa untuk snorkeling dan menikmati keindahan Pulau
                                    yang memiliki satu resort ini.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                ...
                                />
                                <p>
                                    Setelah puas bermain air dan foto-foto di Pulau Kanawa kita siap untuk kembali ke Labuan
                                    Bajo.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Jika waktu masih memungkinkan kita bisa singgah di Pulau Bidadari untuk santai di pantai
                                    dan snorkeling lagi.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                ...
                                />
                                <p>
                                    Tiba di Labuan Bajo anda akan kami antarkan menuju bandara atau hotel tempat menginap
                                    masing-masing.
                                </p>
                            </div>
                            <div className="flex items-center gap-1">
                                <TiMediaPlay
                                    ...
                                    className="-mt-0.5 min-w-[20px]"
                                />
                                <p>Trip selesai, sampai jumpa di trip selanjutnya.</p>
                            </div>
                        </div> */}
                        <div className="flex flex-col gap-2">
                        ...
                        <Accordion
                            ...
                            <AccordionItem header="Pulau Manjarite">
                                <div className="flex flex-col gap-5">
                                    <img
                                        src="https://raw.githubusercontent.com/azhardanii/journey-labuan-bajo-assets/main/pulaumanjarite.webp"
                                        className="rounded-lg "
                                        alt="Journey Labuan Bajo Pulau Manjarite"
                                    />
                                    <p>
                                        Kendati belum sepopuler pulau lain yang berada di kawasan Labuan Bajo, Pulau
                                        Manjarite kerap disebut sebagai “One of The Opening Gates”. Alasannya, karena Pulau
                                        Manjarite merupakan pulau kedua yang dikunjungi dalam rangkaian Sailing Komodo, yaitu
                                        mengelilingi pulau menggunakan kapal pinisi atau boat.
                                    </p>
                                </div>
                            </AccordionItem>
                            ...
                            <AccordionItem header="Pulau Bidadari">
                                <div className="flex flex-col gap-5">
                                    <img
                                        src="https://raw.githubusercontent.com/azhardanii/journey-labuan-bajo-assets/main/pulaubidadari.webp"
                                        className="rounded-lg "
                                        alt="Journey Labuan Bajo Pulau Bidadari"
                                    />
                                    <p>
                                        Seperti halnya pulau-pulau lain yang terkenal, Pulau Bidadari juga menawarkan
                                        berbagai macam daya tarik yang memikat. Hal itu membuat wisatawan yang ingin
                                        mengunjunginya menjadi tertarik untuk mengeksplorasi setiap sudut tempat wisata ini.
                                    </p>
                                </div>
                            </AccordionItem>
                        </Accordion> */}
...
export default Phinisi3D2NSailing;
